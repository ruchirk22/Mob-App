...
import com.mobicom.email.EmailService;
...
import com.mobicom.repository.RechargeHistoryRepository;
  ...
  public RechargeHistory createRechargeHistory(
    ...
    try {
      ...
      if (user != null && plan != null) {
        ...
        String encryptedId = encryption.encrypt(newRechargeHistory.getId());
        htmlContent =
          htmlContent.replace(
            "{{confirmationLink}}",
            "http://localhost:8082/payment/" + encryptedId
          );
